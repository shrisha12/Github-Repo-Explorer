...
def get_languages_used(ghurl): #owner, repo):
    ...
    # {'Python': 440134, 'Shell': 12823, 'Jinja': 10187, 'Dockerfile': 4609, 'CSS': 3810}
    # ['Python', 'Shell', 'Jinja', 'Dockerfile', 'CSS']
    # Python-Shell-Jinja-Dockerfile
    # your code here
...
def send_mail(body):
    ...
    yag = yagmail.SMTP('internship.py')
    for email in emails:
        yag.send(to=email, subject='internship', contents=body,attachments=['lang_data.txt','repo_data.txt','issue_data.txt','pr_data.txt'])
